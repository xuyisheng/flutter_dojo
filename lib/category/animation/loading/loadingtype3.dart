...
class LoadingType3 extends StatefulWidget {
  ...
  @override
  _LoadingType3State createState() => _LoadingType3State();
}

class _LoadingType3State extends State<LoadingType3> with SingleTickerProviderStateMixin {
