...
class LinkedListWidget extends StatefulWidget {
  @override
  _LinkedListWidgetState createState() => _LinkedListWidgetState();
}

class _LinkedListWidgetState extends State<LinkedListWidget> {
