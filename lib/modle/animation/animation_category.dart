...
List<DemoItem> buildSequenceDemoItems(String codePath) {
  return [
    DemoItem(
      ...
      subtitle: 'An abstract class for building widgets that animate changes to their properties.',
    ...
    DemoItem(
      ...
      subtitle: '[Widget] builder that animates a property of a [Widget] to a target value whenever the target value changes.',
